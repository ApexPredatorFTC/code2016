...
public class ColorI2cTest extends LinearOpMode
{
    ...
    public static final I2cAddr c4Addr = I2cAddr.create8bit(0x40);
    ...
    public void runOpMode()
    {
        ...
        while (opModeIsActive())
        {
            ...
            telemetry.addData("Color #",  (c1Cache[0] & 0xff) + " " + (c2Cache[0] & 0xff)+ " " + (c3Cache[0] & 0xff));
            telemetry.addData("Red", (c1Cache[1] & 0xff) + " " + (c2Cache[1] & 0xff)+ " " + (c3Cache[1] & 0xff));
            telemetry.addData("Green", (c1Cache[2] & 0xff) + " " + (c2Cache[2] & 0xff)+ " " + (c3Cache[2] & 0xff));
            telemetry.addData("Blue", (c1Cache[3] & 0xff) + " " + (c2Cache[3] & 0xff)+ " "+ (c3Cache[3] & 0xff));
            telemetry.addData("White", (c1Cache[4] & 0xff) + " " + (c2Cache[4] & 0xff)+ " "+ (c3Cache[4] & 0xff));
            telemetry.addData("Color Index Number", (c1Cache[5] & 0xff) + " " + (c2Cache[5] & 0xff)+ " " + (c3Cache[5] & 0xff));
            telemetry.addData("Red Index", (c1Cache[6] & 0xff) + " " + (c2Cache[6] & 0xff)+ " " + (c3Cache[6] & 0xff)) ;
            telemetry.addData("Green Index", (c1Cache[7] & 0xff) + " " + (c2Cache[7] & 0xff)+ " "+ (c3Cache[7] & 0xff));
            telemetry.addData("Blue Index", (c1Cache[8] & 0xff) + " " + (c2Cache[8] & 0xff) + " "+ (c3Cache[8] & 0xff));
            telemetry.addData("Undefined", (c1Cache[9] & 0xff) + " " + (c2Cache[9] & 0xff) + " "+ (c3Cache[9] & 0xff));
            ...
            telemetry.addData("Norm White LSB", (c1Cache[24] & 0xff) + " " + (c2Cache[24] & 0xff) + " "+ (c3Cache[24] & 0xff));
            telemetry.update();
